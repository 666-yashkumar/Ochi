...
const Footer = () => {
  return (
    <div className="w-full h-screen flex gap-10 p-20 bg-zinc-800">
      <div className="w-1/2 h-full flex  flex-col justify-between">
        <div className="heading ">
          <h1 className="text-[6vw] uppercase font-semibold -mb-4 text-purple-200 font-serif leading-none">
            Eye-
          </h1>
          <h1 className="text-[6vw] uppercase font-semibold -mb-4 text-purple-400 font-serif leading-none">
            Opening 
          </h1>
        </div>
        <div>
      ...
      <div className="w-1/2">
        <h1 className="text-[4vw] uppercase font-bold -mb-4 text-purple-100 font-serif leading-none">
            presentation
          </h1>
          <div className="link mt-5 border-t-2 ">
            <a className="block mt-3 text-xl font-light hover:text-blue-700 transition hover:font-bold duration-300" href="#">Instagram</a>
            <a className="block mt-6 text-xl font-light hover:text-blue-700 transition hover:font-bold duration-300" href="#">Facebook</a>
            <a className="block mt-6 text-xl font-light hover:text-blue-700 transition hover:font-bold duration-300" href="#">Youtube</a>
          </div>
        </div>
    </div>
  );
